...
class ObjectDetect:
    """API wrapper from Grounding DINO 1.5
    ...
    def generate(self, image:str, prompt: str, return_mask:bool=False):
        ...
        Returns:
            ...
            The number of object occurances

        """
        # construct input prompts
        image=self.get_image_url(image),
        task=DetectionTask(
            image_url=image[0],
